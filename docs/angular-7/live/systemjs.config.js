(function (global) {
  System.config({
    ...
    map: {
      app: 'build-20260524-angular7-npm/app',
      ...
      '@stackline/angular-multiselect-dropdown': 'build-20260524-angular7-npm/node_modules/@stackline/angular-multiselect-dropdown',
