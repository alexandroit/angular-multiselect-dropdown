(function (global) {
  System.config({
    ...
    map: {
      app: 'build-20260524-angular6-npm/app',
      ...
      '@stackline/angular-multiselect-dropdown': 'build-20260524-angular6-npm/node_modules/@stackline/angular-multiselect-dropdown',
