...
export class AppComponent implements OnInit {
  ...
  readonly apiCards = [
    ...
    },
    {
      ...
      copy: 'Set tagToBody to true inside Angular Material dialogs, modals, drawers, and overflow containers. In the 22.1.x line the open list uses layout-stable overlay positioning across every shipped skin, stays aligned to the trigger, keeps an opaque surface, closes cleanly, and no longer expands the host form or leaves a hidden layout box behind.'
    },
    {
      kicker: 'Styling',
  ...
  private readonly stackBlitzBaseUrl = 'https://stackblitz.com/github/alexandroit/stackline-angular-multiselect-angular-22';
