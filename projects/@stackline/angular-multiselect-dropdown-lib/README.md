...
The repository contains the full documentation matrix from Angular 2 through Angular 21. The current package release is `21.1.3` for Angular 21.x applications.
